...
class Services 
{
	...
	private static $_attributes=["IdService","nomService","IdOrganisation"];
	/***************** Accesseurs ***************** */
	...
	public function setNomService(string $nomService)
	{
	...
	*/
	...
	{
		return "IdService : ".$this->getIdService()."NomService : ".$this->getNomService()."IdOrganisation : ".$this->getIdOrganisation()."\n";
	}
